...
const owner = () => select("owner", "负责人", "PIC", ownerOptions);
...
const reviewBaseFields = [text("reviewNo", "审核编号", "Review No."), text("paymentNo", "支付编号", "Payment No."), text("postId", "Post ID"), date("plannedPostDate", "计划发布日期", "Planned Post Date"), date("actualPostDate", "实际发布日期", "Actual Post Date"), text("postSequence", "帖子序号", "Post Sequence"), text("creatorName", "达人", "Creator"), owner(), text("ownerDept", "负责人部门", "PIC Department"), number("unitPrice", "单价", "Unit Price"), brand(), product(), select("postStatus", "帖子状态", "Post Status", statusOptions), select("videoType", "视频类型", "Video Type", contentTypeOptions), text("classification", "Classification"), text("videoSource", "Video Source"), text("adType", "Ad Type"), date("createdAt", "创建时间", "Created At")];
...
Object.assign(pageConfigs, {
  reviews: {
    ...
    filters: [country(), text("reviewNo", "视频编号", "Video No."), brand(), date("actualPostDate", "Post Date"), text("postId", "Post ID"), number("unitPrice", "单价", "Unit Price"), owner()], fields: reviewBaseFields,
    columns: [column("reviewNo", "视频编号", "Video No."), column("paymentNo", "支付编号", "Payment No."), column("postId", "Post ID"), column("actualPostDate", "Post Date"), column("postSequence", "帖子序号", "Post Sequence"), column("createdAt", "创建时间", "Created At"), column("creatorName", "达人", "Creator"), column("owner", "负责人", "PIC"), column("ownerDept", "负责人部门", "PIC Department"), column("postStatus", "视频状态", "Video Status"), column("unitPrice", "单价", "Unit Price"), column("brand", "品牌", "Brand"), column("product", "产品", "Product")], actions: ["add", "edit", "delete", "export"],
    seed: [{ id: 1, reviewNo: "RID20260803108934", paymentNo: "PID2026071785463", postId: "766849779127", actualPostDate: "2026-07-31", postSequence: "VT 6", createdAt: "2026-08-02", creatorName: "tesatemaduraa", owner: "Delvi", ownerDept: "Brand Marketing", postStatus: "Published", unitPrice: 850000, brand: "Glowsicha", product: "Day Cream" }],
  },
  lsaReviews: {
  ...
  lsaKocReviews: {
    ...
    columns: [column("reviewNo", "审核编号", "Review No."), column("paymentNo", "支付编号", "Payment No."), column("postId", "Post ID"), column("actualPostDate", "实际发布日期", "Actual Post Date"), column("postStatus", "帖子状态", "Post Status"), column("createdAt", "创建时间", "Created At"), column("creatorName", "达人", "Creator"), column("owner", "负责人", "PIC"), column("unitPrice", "单价", "Unit Price"), column("brand", "品牌", "Brand"), column("product", "产品", "Product")], actions: ["add", "edit", "delete", "export"],
  ...
  inhouseContent: {
    ...
    columns: [column("country", "国家", "Country"), column("contentNo", "编号", "No."), column("brand", "品牌", "Brand"), column("owner", "PIC"), column("project", "项目", "Project"), column("product", "产品", "Product"), column("videoId", "视频ID", "Video ID"), column("postDate", "发布日期", "Post Date")], actions: ["import", "export"],
...
Object.assign(pageConfigs, {
  payment: {
    ...
    filters: [country(), text("paymentNo", "支付编号", "Payment No."), text("creatorName", "达人", "Creator"), brand(), date("paymentStart", "付款日期", "Payment Date"), date("paymentEnd", "结束日期", "End Date"), { key: "supervisorPending", zh: "Supervisor 待审批", en: "Supervisor Pending", kind: "checkbox" }, { key: "ceoPending", zh: "CEO 待审批", en: "CEO Pending", kind: "checkbox" }], fields: paymentFields,
    ...
    actions: ["add", "edit", "delete", "export", "approve"],
    seed: [{ id: 1, paymentNo: "PID2026080286752", createdAt: "2026-08-02", paymentDate: "2026-08-05", owner: "Delvi", department: "Brand Marketing", supervisor: "Nadia", creatorName: "tesatemaduraa", followersK: 184, ownContent: "No", platform: "TikTok", brand: "Glowsicha", contentType: "Vlog", rateTier: "A", gracePeriod: 7, unitPrice: 850000, qty: 6, totalPrice: 5100000, reviewQty: 6, qtyMismatch: "No", expectedPostDate: "2026-08-12", actualPostDate: "", progress: "65%", notes: "August collaboration", paymentBank: "BCA", bankName: "Bank Central Asia", accountName: "Tesate Maduraa", bankAccount: "**** 8201", idNumber: "KTP verified", idName: "Tesate Maduraa", invoiceFiles: "invoice-86752.pdf", paid: "No", paymentProof: "—", agreement: "agreement.pdf", negotiation: "chat-proof.zip", invoiceVerified: "Approved", financeNotes: "Ready for approval", supervisorApproval: "Approved", ceoApproval: "Pending", qtyConsistent: "Yes" }],
  },
  paymentPriceChange: {
...
const overviewColumns = [column("brand", "品牌", "Brand"), column("product", "Product"), column("owner", "负责人", "PIC"), column("budget", "Budget"), column("cost", "Cost"), column("budgetRate", "%"), column("viewsTarget", "Views Target"), column("views", "Views"), column("viewsRate", "%"), column("qtyTarget", "QTY Target"), column("qty", "QTY"), column("qtyRate", "%")];
...
pageConfigs.kolTargetReport = {
  ...
  views: [
    ...
    { key: "cost", zh: "成本汇总", en: "Cost Summary", columns: [column("brand", "品牌", "Brand"), column("owner", "负责人", "PIC"), column("product", "Product"), column("cost", "Cost"), column("qty", "QTY")] },
    { key: "performance", zh: "效果汇总", en: "Performance", columns: performanceColumns },
    { key: "video", zh: "视频明细", en: "Video Detail", columns: [column("videoLink", "Video Link"), column("creatorName", "Creator Name"), column("brand", "品牌", "Brand"), column("product", "Product Name"), column("owner", "负责人", "PIC"), column("postDate", "Post Date"), column("videoCost", "Video Cost")] },
  ],
...
Object.assign(pageConfigs, {
  brandData: {
    ...
    filters: [country(), text("brandName", "品牌名称", "Brand Name"), text("shortName", "简称", "Short Name")], fields: [text("brandName", "品牌名称", "Brand Name"), text("shortName", "简称", "Short Name"), text("sellingCountries", "在售国家/地区", "Selling Countries"), text("brandManager", "品牌经理", "Brand Manager"), text("pic", "PIC")],
    columns: [column("brandName", "品牌名称", "Brand Name"), column("shortName", "简称", "Short Name"), column("sellingCountries", "在售国家/地区", "Selling Countries"), column("brandManager", "品牌经理", "Brand Manager"), column("pic", "PIC"), column("createdBy", "创建人", "Created By"), column("createdAt", "创建时间", "Created At")], actions: ["add", "edit", "delete", "export"],
...
export const menuGroups: { key: string; zh: string; en: string; pages: { key: PageKey; zh: string; en: string }[] }[] = [
  ...
  { key: "target", zh: "Target", en: "Target", pages: [{ key: "targetDashboard", zh: "Dashboard", en: "Dashboard" }, { key: "target1", zh: "Target 1.0", en: "Target 1.0" }, { key: "productTarget", zh: "Target", en: "Target" }, { key: "ownTarget", zh: "Own Target", en: "Own Target" }] },
  { key: "creator", zh: "Creator", en: "Creator", pages: [{ key: "creator", zh: "Creator", en: "Creator" }, { key: "sample", zh: "Sample", en: "Sample" }] },
  { key: "content", zh: "Content", en: "Content", pages: [{ key: "reviews", zh: "Reviews", en: "Reviews" }, { key: "lsaReviews", zh: "LSA Reviews", en: "LSA Reviews" }, { key: "lsaKocReviews", zh: "LSA KOC Reviews", en: "LSA KOC Reviews" }, { key: "ownMediaReview", zh: "Own Media Review", en: "Own Media Review" }, { key: "inhouseContent", zh: "Inhouse Content", en: "Inhouse Content" }, { key: "campaign", zh: "Campaign", en: "Campaign" }] },
...
export const roles: { key: RoleKey; zh: string; en: string; groups: string[]; canEdit: string[]; canApprove: string[] }[] = [
  ...
  { key: "kolPic", zh: "KOL PIC", en: "KOL PIC", groups: ["home", "target", "creator", "content", "finance"], canEdit: ["creator", "content", "finance"], canApprove: [] },
