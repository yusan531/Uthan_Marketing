    ...
    <main className="app-shell">
      ...
      <section className="main-area">
        ...
        <div className="content">
          {active === "Marketing 3.0" ? <div className="integrated-demo"><div className="integrated-demo-head"><div><p className="eyebrow">INTEGRATED MODULE · MARKETING 3.0</p><h1>目标与达成</h1><p className="subheading">已融合进 Marketing 工作台，所有筛选、展开、报告和发布进度交互都在这里运行。</p></div><button className="ghost-btn" onClick={() => setActive("总览")}>← 返回总览</button></div><iframe title="Marketing 3.0 目标与达成" src="/marketing-3-demo/index.html" /></div> : <>
